# API bancaire JavaScript - Sharifatou Malai
...
- Cahier des charges PDF : `http://127.0.0.1:8006/cahier-de-charges`
- Cahier des charges Markdown : `http://127.0.0.1:8006/cahier-de-charges.md`

## Déploiement sur Render

Créer un **Web Service** Render avec les paramètres suivants :

- Root Directory : `api-javascript-sharifatou`
- Runtime : `Node`
